                      ...
                      return Column(
                        children: [
                          Container(
                            ...
                            child: Text(
                              "Welcome to ${Global.selected.name.toUpperCase()}",
                          ...
                          Text(
                            "${Global.selected.distanceSun} million km",
                            style: TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                              color: Colors.white.withOpacity(0.8),
                          ...
                          Text(
                            "${Global.selected.distanceEarth} million km",
                            style: TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                              color: Colors.white.withOpacity(0.8),
